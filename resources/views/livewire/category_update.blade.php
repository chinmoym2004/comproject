<div wire:ignore.self class="modal fade" id="updatecategoryModel" tabindex="-1" aria-labelledby="updatecategoryModelLabel" aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="updatecategoryModelLabel">Update Category</h5>
