...
window.addEventListener("chat-grpup-deleted", function (event) {//alert(`${event.detail.title} was deleted!`);
});
...
window.addEventListener("group-saved", function (event) {
  $("#createChatGroupModal").modal("hide"); //alert(`Chat Group ${event.detail.title} was ${event.detail.action}!`);
});
...
Livewire.on("userTopicCreate", function () {
  console.log("OK");
  $("#createTopicsModal").modal("show");
});
window.addEventListener("usercommented", function (event) {
  console.log("OK commentCreated");
  Livewire.emit("commentCreated");
});
window.addEventListener("subcommented", function (event) {
...
window.addEventListener("topic-deleted", function (event) {// alert(`${event.detail.title} was deleted!`);
});
...
Livewire.on("fetchedGroupForCircular", function () {
  $("#createcircularModal").modal("show");
  $("#createcircularModal .select2").select2();
});
window.addEventListener("circular-saved", function (event) {
  $("#createcircularModal").modal("hide"); //alert(`circular ${event.detail.title} was ${event.detail.action}!`);
});
...
window.addEventListener("circular-deleted", function (event) {//alert(`${event.detail.title} was deleted!`);
});
...
window.addEventListener("group-saved", function (event) {
  $("#creategroupModal").modal("hide"); //alert(`group ${event.detail.title} was ${event.detail.action}!`);
});
