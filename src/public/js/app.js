...
var token = $('meta[name="csrf-token"]').attr("content"); //document.head.querySelector('meta[name="csrf-token"]');
...
window.Echo = new laravel_echo__WEBPACK_IMPORTED_MODULE_0__["default"]({
  ...
  token: "2469|bScUFactsT1sx85bVqxS8y571zFvL6ZXq9uZLQGw"
