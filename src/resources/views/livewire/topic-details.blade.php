        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools text-muted">
                    <p><a href="{{ url('forums') }}">Forums</a>&nbsp;&nbsp;<i class="fa fa-angle-right text-muted"></i>&nbsp;&nbsp;<a href="{{ url('forums/'.encrypt($topic->forum_id)) }}">{{ $topic->forum->name }}</a>&nbsp;&nbsp;<i class="fa fa-angle-right text-muted"></i>&nbsp;&nbsp;Topics</p>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="text-muted">
                    <p class="text-sm">Forum Name
                        <b class="d-block"><a href="{{ url('forums/'.encrypt($topic->forum_id)) }}">{{ $topic->forum->name }}</a></b>
                    </p>
