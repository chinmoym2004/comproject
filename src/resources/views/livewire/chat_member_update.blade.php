<div wire:ignore.self class="modal fade" id="chatMemberUpdateModal" tabindex="-1" aria-labelledby="chatMemberUpdateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="chatMemberUpdateModalLabel">Update Chat Members</h5>
