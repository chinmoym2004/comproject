                    ...
                    <li class="clearfix">
                        <div class="message-data text-right">
                            <div class="d-flex justify-content-end">
                                ...
                                <span class="message-data-time"><span>{{$eachmessge['user']['name']}}</span><br/><span class="text-muted text-sm">{{ $eachmessge['message']['time'] }}</span></span></span>
                                @endif
                                <img src="{{ $eachmessge['user']['avatar'] }}" alt="avatar" class="ml-1">
                            </div>
                        </div>
